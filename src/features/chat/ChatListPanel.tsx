                ...
                {filteredChats.map((chat, index) => (
                    ...
                    >
                        ...
                        <div className="relative flex-shrink-0 ml-1 sm:ml-2">
                            <button
                                className="flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 text-[#94A3B8] hover:text-[#E74C3C] hover:bg-[#F2D6CD]/50 rounded-full transition-all duration-200 hover:scale-110"
                                onClick={(e) => {
                                    e.stopPropagation();
                            ...
                            {/* Menú desplegable */}
                            {openMenuId === chat.id && (
                                <div className="absolute right-0 top-10 sm:top-12 w-52 sm:w-56 bg-white rounded-xl shadow-2xl border border-[#F2D6CD] z-30 py-2 animate-fadeIn">
                                    {/* Header del menú */}
                                    <div className="px-3 sm:px-4 py-2 sm:py-3 border-b border-[#F2D6CD] bg-gradient-to-r from-[#F2D6CD]/30 to-white">
                                        <p className="text-xs sm:text-sm font-semibold text-[#1E293B] truncate">{chat.contacto.nombres} {chat.contacto.apellidos}</p>
                                        <p className="text-[10px] sm:text-xs text-[#64748B] mt-0.5">Opciones de chat</p>
                                    </div>
                                    
                                    <button 
                                        className="flex items-center w-full px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#1E293B] hover:bg-gradient-to-r hover:from-[#F2D6CD]/30 hover:to-white transition-all duration-200"
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            handleMenuAction('Bloquear', chat.id, chat.contacto.nombres);
                                        }}
                                    >
                                        <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-2 sm:mr-3 text-[#E74C3C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="border-t border-[#F2D6CD] my-1"></div>
                                    
                                    <button 
                                        className="flex items-center w-full px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-red-600 hover:bg-gradient-to-r hover:from-red-50 hover:to-[#F2D6CD]/30 transition-all duration-200"
                                        onClick={(e) => {
                                            e.stopPropagation();
