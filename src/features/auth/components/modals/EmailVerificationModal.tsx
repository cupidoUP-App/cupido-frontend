      ...
      <div className="w-[439px] h-[680px] bg-transparent rounded-[40px] shadow-[2px_6px_4px_0px_rgba(0,0,0,0.35)] relative overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col p-8">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            {/* Alerta - Revisar correo no deseado */}
            <div className="mb-3 px-3 py-2 bg-amber-50 border border-amber-300 rounded-md flex items-center gap-2">
              <svg className="w-4 h-4 text-amber-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
              <p className="text-[10px] text-amber-700 font-['Poppins']">
                ¿No lo encuentras? Revisa tu <span className="font-bold">Correo No Deseado (Spam)</span>
              </p>
            </div>
