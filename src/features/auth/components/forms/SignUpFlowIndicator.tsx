/** Indicador visual del estado de verificación reCAPTCHA en el flujo de registro. */

import React from 'react';

/** Props del indicador de flujo de registro. */
interface SignUpFlowIndicatorProps {
  isCaptchaVerified: boolean;
}

export const SignUpFlowIndicator: React.FC<SignUpFlowIndicatorProps> = ({ isCaptchaVerified }) => {
  return (
    <div className="mb-4">
      {!isCaptchaVerified ? (
