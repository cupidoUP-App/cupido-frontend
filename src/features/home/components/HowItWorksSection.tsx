...
export default function HowItWorksSection() {
  ...
  return (
    <section id="how" className="py-12 sm:py-20 lg:py-32 bg-background" ref={animationRef}>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Step number con borde pronunciado */}
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-12 h-12 bg-primary border-2 border-primary/80 rounded-2xl flex items-center justify-center text-white font-bold text-lg shadow-[3px_3px_0px_0px_rgba(0,0,0,0.15)]">
                    {step.step}
                  </div>

                  {/* Card */}
                  <div className="card-floating pt-12 pb-8 px-6 mt-8 group">
                    <div className="w-16 h-16 bg-primary/10 border-2 border-primary/20 rounded-3xl flex items-center justify-center mx-auto mb-6 transition-all duration-300 group-hover:scale-110 group-hover:shadow-[3px_3px_0px_0px_hsl(var(--primary)/0.3)]">
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden lg:block absolute top-1/2 -right-6 w-12 h-0.5 bg-primary/40" />
                  )}
                </div>
              );
            })}
          ...
          <div className="relative mt-16 hidden lg:block opacity-0" data-animate="animate-fade-in" data-animate-delay="500ms">
            ...
            <div className="relative flex justify-center text-center">
              <span className="bg-white px-4 py-2 text-sm text-muted-foreground font-medium rounded-full border-2 border-primary/30 shadow-[2px_2px_0px_0px_hsl(var(--primary)/0.15)]">
